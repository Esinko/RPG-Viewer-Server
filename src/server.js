...
socketServer.use((socket, next) => { // TODO: Security through obscurity? Should the given error be more verbose?
...
socketServer.on("connection", (socket) => {
    ...
    const sessionInfo = { // TODO: Type incomplete
        id: null,
        master: null,
        masterId: null,
        synced: null,
    ...
    socket.on("download-image", (imageId, callback) => downloadImage(accountInfo, sessionInfo, imageId, callback))
    socket.on("get-user", (email, name, password, callback) => getUser(email, name, password, callback))
